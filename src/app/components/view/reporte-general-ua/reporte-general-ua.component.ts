...
@Component({
  selector: 'app-reporte-general-ua',
  templateUrl: './reporte-general-ua.component.html',
  styleUrls: ['./reporte-general-ua.component.css']
})
export class ReporteGeneralUaComponent implements OnInit {
  ...
  getReporte(): void {
    ...
    this.reporteSRV.getReporteFinanciamientoMasPersonalUA(this.user.id_ciclo, this.user.id_etapa).subscribe(res => {
      console.log('entra a mi');
      this.lista_rep = res;
