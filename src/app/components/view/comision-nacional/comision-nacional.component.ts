...
@Component({
  selector: 'app-comision-nacional',
  templateUrl: './comision-nacional.component.html',
  styleUrls: ['./comision-nacional.component.css']
})
export class ComisionNacionalComponent implements OnInit {
  ...
  exportAsXLSX(): void {
    ...
    this.comisionService.getAllComisionVehReporteServicios(this.user.codigo, 1, 0, this.user.id_ciclo, this.user.id_etapa).subscribe(res => {
  ...
  getAllComisionVehiculo() {
    ...
    this.comisionService.getAllComisionVehServicios(this.user.codigo, 1, 0, this.user.id_ciclo, this.user.id_etapa).subscribe(res => {
  ...
  getElemento(elemento) {
    ...
    this.productoService.getProductoxFiltro(this.id_ugp, this.user.codigo).subscribe(res => {
      ...
      this.accionesService.getAllAccionesxFiltro(this.id_producto, this.user.codigo, 0).subscribe(res => {
        this.acciones = res;
      });
    });
