...
@Component({
  selector: 'app-comision-local-adicional',
  templateUrl: './comision-local-adicional.component.html',
  styleUrls: ['./comision-local-adicional.component.css']
})
export class ComisionLocalAdicionalComponent implements OnInit {
  lista_comision: any = [];
  lista_comision_reporte: any = [];
  flagbtn = true;
  ...
  exportAsXLSX(): void {
    var excel = [];
    this.flagbtn = false;
    this.comisionService.getAllComisionVehReporteServicios(this.user.codigo, 2, 1, this.user.id_ciclo, this.user.id_etapa).subscribe(res => {
  ...
  getAllComisionVehiculo() {
    ...
    this.comisionService.getAllComisionVehServicios(this.user.codigo, 2, 1, this.user.id_ciclo, this.user.id_etapa).subscribe(res => {
  ...
  getElemento(elemento) {
    ...
    this.productoService.getProductoxFiltro(this.id_ugp, this.user.codigo).subscribe(res => {
      ...
      this.accionesService.getAllAccionesxFiltro(this.id_producto, this.user.codigo, 1).subscribe(res => {
        this.acciones = res;
      });
    });
  ...
  getDestino(elemento) {
    ...
    this.destino.id_tipo_movilidad = 1;
    this.destino.tarifa = 0;
    this.destino.id_vehiculo = 0;
    this.getAllRegion();
    this.getAllDestinoComision();
  }

  getAllRegion() {
    this.regionService.getAllDepartarmentoOrgano(this.comision.id_organo).subscribe(res => {
      this.lista_dep = res;
  ...
  guardarComision() {
    ...
    this.comision.id_tipo_comision = 2;
